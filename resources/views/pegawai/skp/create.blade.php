            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <form class="form-horizontal" method="POST" action="/pegawai/skp/add">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tugas"  value=""  required>
                                </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="kuantitas"  value="" required>
                                </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="kualitas"  value="" required>
                                </div>
                                </div>
