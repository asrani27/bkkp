            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <form class="form-horizontal" method="POST" action="/pegawai/realisasi/edit/{{$data->id}}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="realisasi" value="{{$data->realisasi}}" required>
                                </div>
                                </div>
